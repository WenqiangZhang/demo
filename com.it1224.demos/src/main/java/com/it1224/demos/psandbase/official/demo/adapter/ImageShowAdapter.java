...
public class ImageShowAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (!AbStrUtil.isEmpty(imagePath)) {
            ...
            //缓存中没有则从网络和SD卡获取
            if (bitmap == null) {
                holder.mImageView1.setImageResource(R.mipmap.image_loading);
                if (imagePath.indexOf("http://") != -1) {
                    ...
                    try {
                        ...
                        holder.mImageView1.setImageResource(R.mipmap.image_error);
                    }
                } else {
                    ...
                    if (mBitmap != null) {
                        ...
                        // 无图片时显示
                        holder.mImageView1.setImageResource(R.mipmap.image_empty);
                    }
                }
            } else {
                //直接显示
