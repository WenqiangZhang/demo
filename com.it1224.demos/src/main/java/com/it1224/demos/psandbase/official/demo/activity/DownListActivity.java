...
import com.it1224.demos.psandbase.official.demo.adapter.MyExpandableListAdapter;
...
import com.it1224.demos.psandbase.official.util.download.DownFileDao;
...
public class DownListActivity extends AbActivity {
    ...
    private void initDownFileList() {
        ...
        mDownFile1.setIcon(String.valueOf(R.mipmap.default_pic));
        ...
        mDownFile2.setIcon(String.valueOf(R.mipmap.default_pic));
        ...
        mDownFile3.setIcon(String.valueOf(R.mipmap.default_pic));
