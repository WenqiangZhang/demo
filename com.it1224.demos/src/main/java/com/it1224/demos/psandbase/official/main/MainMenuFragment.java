...
import com.it1224.demos.psandbase.official.demo.activity.DemoMainActivity;
import com.it1224.demos.psandbase.official.im.activity.ContacterActivity;
import com.it1224.demos.psandbase.official.im.activity.MessageActivity;
import com.it1224.demos.psandbase.official.login.AboutActivity;
...
public class MainMenuFragment extends Fragment {
    ...
    public void initMenu() {
        ...
        m0.setIconId(R.mipmap.square);
        m0.setText("联系人");
        mChild1.add(m0);

        AbMenuItem m1 = new AbMenuItem();
        m1.setIconId(R.mipmap.square);
        m1.setText("我的消息");
        mChild1.add(m1);

        AbMenuItem m3 = new AbMenuItem();
        m3.setIconId(R.mipmap.share);
        m3.setText("程序案例");
        mChild1.add(m3);

        AbMenuItem m4 = new AbMenuItem();
        m4.setIconId(R.mipmap.app);
        m4.setText("应用游戏");
        mChild1.add(m4);

        AbMenuItem m5 = new AbMenuItem();
        m5.setIconId(R.mipmap.set);
        m5.setText("支持我");
        mChild2.add(m5);

        AbMenuItem m6 = new AbMenuItem();
        m6.setIconId(R.mipmap.recommend);
        m6.setText("推荐给好友");
        mChild2.add(m6);
        ...
        if (application.isLogin) {
            ...
            m7.setIconId(R.mipmap.quit);
            m7.setText("注销");
            mChild2.add(m7);
        }

        AbMenuItem m8 = new AbMenuItem();
        m8.setIconId(R.mipmap.about);
        m8.setText("关于");
        mChild2.add(m8);
