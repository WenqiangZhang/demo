...
public class TabBottomActivity extends AbActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mBottomTabView.setTabBackgroundResource(R.mipmap.tab_bg2);
        mBottomTabView.setTabLayoutBackgroundResource(R.mipmap.tablayout_bg2);

        //注意图片的顺序
        tabDrawables = new ArrayList<Drawable>();
        tabDrawables.add(this.getResources().getDrawable(R.mipmap.menu1_n));
        tabDrawables.add(this.getResources().getDrawable(R.mipmap.menu1_f));
        tabDrawables.add(this.getResources().getDrawable(R.mipmap.menu2_n));
        tabDrawables.add(this.getResources().getDrawable(R.mipmap.menu2_f));
        tabDrawables.add(this.getResources().getDrawable(R.mipmap.menu3_n));
        tabDrawables.add(this.getResources().getDrawable(R.mipmap.menu3_f));
        tabDrawables.add(this.getResources().getDrawable(R.mipmap.menu4_n));
        tabDrawables.add(this.getResources().getDrawable(R.mipmap.menu4_f));
