 ...
 */
package com.it1224.demos.psandbase.official.view.carousel;
...
public class CarouselView extends CarouselSpinner implements GestureDetector.OnGestureListener {
     ...
     * @author: amsoft.cn
     * @date：2013-11-28 上午11:14:35
     * @see View#onFocusChanged(boolean, int, Rect)
     */
    @Override
     ...
     * @author: amsoft.cn
     * @date：2013-11-28 上午11:14:35
     * @see ViewGroup#checkLayoutParams(ViewGroup.LayoutParams)
     */
    @Override
     ...
     * @author: amsoft.cn
     * @date：2013-11-28 上午11:14:35
     * @see ViewGroup#generateLayoutParams(ViewGroup.LayoutParams)
     */
    @Override
     ...
     * @author: amsoft.cn
     * @date：2013-11-28 上午11:14:35
     * @see ViewGroup#generateLayoutParams(AttributeSet)
     */
    @Override
     ...
     * @author: amsoft.cn
     * @date：2013-11-28 上午11:14:35
     * @see ViewGroup#dispatchSetPressed(boolean)
     */
    @Override
     ...
     * @author: amsoft.cn
     * @date：2013-11-28 上午11:14:35
     * @see ViewGroup#showContextMenuForChild(View)
     */
    @Override
     ...
     * @author: amsoft.cn
     * @date：2013-11-28 上午11:14:35
     * @see ViewGroup#dispatchKeyEvent(KeyEvent)
     */
    @Override
     ...
     * @author: amsoft.cn
     * @date：2013-11-28 上午11:14:35
     * @see GestureDetector.OnGestureListener#onFling(MotionEvent, MotionEvent, float, float)
     */
     ...
     * @author: amsoft.cn
     * @date：2013-11-28 上午11:14:35
     * @see GestureDetector.OnGestureListener#onScroll(MotionEvent, MotionEvent, float, float)
     */
     ...
     * @author: amsoft.cn
     * @date：2013-11-28 上午11:14:35
     * @see GestureDetector.OnGestureListener#onShowPress(MotionEvent)
     */
