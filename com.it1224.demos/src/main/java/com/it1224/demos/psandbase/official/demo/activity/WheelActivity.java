...
public class WheelActivity extends AbActivity {
    ...
    public void initWheelData1(View mDataView1) {
        ...
        mWheelView1.setCenterSelectDrawable(this.getResources().getDrawable(R.mipmap.wheel_select));
    ...
    public void initWheelTime(View mTimeView, TextView mText) {
        ...
        mWheelViewMD.setCenterSelectDrawable(this.getResources().getDrawable(R.mipmap.wheel_select));
        mWheelViewMM.setCenterSelectDrawable(this.getResources().getDrawable(R.mipmap.wheel_select));
        mWheelViewHH.setCenterSelectDrawable(this.getResources().getDrawable(R.mipmap.wheel_select));
    ...
    public void initWheelDate(View mDateView, TextView mText) {
        ...
        mWheelViewY.setCenterSelectDrawable(this.getResources().getDrawable(R.mipmap.wheel_select));
        mWheelViewM.setCenterSelectDrawable(this.getResources().getDrawable(R.mipmap.wheel_select));
        mWheelViewD.setCenterSelectDrawable(this.getResources().getDrawable(R.mipmap.wheel_select));
