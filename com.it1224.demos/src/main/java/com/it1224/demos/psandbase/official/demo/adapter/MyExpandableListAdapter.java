package com.it1224.demos.psandbase.official.demo.adapter;
...
import com.it1224.demos.psandbase.official.util.download.AbDownloadProgressListener;
import com.it1224.demos.psandbase.official.util.download.AbDownloadThread;
import com.it1224.demos.psandbase.official.util.download.AbFileDownloader;
import com.it1224.demos.psandbase.official.util.download.DownFile;
    ...
    public View getChildView(int groupPosition, int childPosition,
        ...
        if (mDownFile != null) {
            ...
            if (mDownFile.getState() == Constant.undownLoad) {
                holder.operateBtn.setBackgroundResource(R.mipmap.down_load);
                ...
                holder.operateBtn.setBackgroundResource(R.mipmap.down_pause);
                ...
                holder.operateBtn.setBackgroundResource(R.mipmap.down_delete);
                holder.received_progressBar.setVisibility(View.GONE);
                holder.itemsDesc.setVisibility(View.VISIBLE);
            }
