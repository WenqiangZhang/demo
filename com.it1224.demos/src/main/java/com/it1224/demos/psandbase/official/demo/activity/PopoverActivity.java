...
public class PopoverActivity extends AbActivity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        popoverView.setBackgroundDrawable(this.getResources().getDrawable(R.mipmap.popover_bg));
        popoverView.setArrowLeftDrawable(this.getResources().getDrawable(R.mipmap.popover_arrow_left));
        popoverView.setArrowRightDrawable(this.getResources().getDrawable(R.mipmap.popover_arrow_right));
        popoverView.setArrowDownDrawable(this.getResources().getDrawable(R.mipmap.popover_arrow_down));
        popoverView.setArrowUpDrawable(this.getResources().getDrawable(R.mipmap.popover_arrow_up));
